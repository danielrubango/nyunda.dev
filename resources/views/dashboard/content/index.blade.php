            ...
            <x-ui.card>
                <form method="GET" action="{{ route('dashboard.content.index') }}" class="grid gap-3 sm:grid-cols-4">
                    <label class="text-sm font-medium text-zinc-700">
                        Recherche
                        <input name="q" type="text" value="{{ $searchFilter }}" class="mt-1 w-full border border-zinc-300 px-3 py-2 text-sm">
                    </label>
                    <label class="text-sm font-medium text-zinc-700">
                        Statut
                        <select name="status" class="mt-1 w-full border border-zinc-300 px-3 py-2 text-sm">
                    ...
                    <label class="text-sm font-medium text-zinc-700">
                        Type
                        <select name="type" class="mt-1 w-full border border-zinc-300 px-3 py-2 text-sm">
                            <option value="">Tous</option>
                        ...
                        <tbody class="divide-y divide-zinc-200">
                            @forelse ($contentItems as $row)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-zinc-700">{{ $row['status_label'] }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-6 text-center text-zinc-500">Aucun contenu trouve.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
